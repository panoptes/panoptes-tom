...
class SiderealTargetCreateForm(TargetForm):
    field_ra = CoordinateField(required=True, label='Right Ascension', c_type='field_ra',
    ...
    field_dec = CoordinateField(required=True, label='Declination', c_type='field_dec',
